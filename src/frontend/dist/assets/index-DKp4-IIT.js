...
function ParticleCanvas() {
  ...
  reactExports.useEffect(() => {
    ...
    const N = Math.floor(canvas.width * canvas.height / 12e3);
    for (let i = 0; i < N; i++) {
      particles.push({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      style: {
        ...
        borderBottom: scrolled ? "1px solid oklch(0.25 0.04 258 / 0.5)" : "none"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-6 py-4 flex items-center justify-between", children: [
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "radial-gradient(ellipse at 20% 50%, oklch(0.10 0.04 260) 0%, oklch(0.07 0.02 260) 60%)"
      },
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-6 max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-label mb-4", children: "Welcome to my portfolio" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              style: { color: "oklch(0.73 0.04 250)" },
              children: "Software Developer & Graduate"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Passionate about building intelligent systems and solving complex problems with code. Specializing in Java, Python, and Machine Learning applications."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onClick: () => {
                  var _a2;
                  return (_a2 = document.querySelector("#projects")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                },
                ...
                onMouseEnter: (e) => {
                  ...
                  e.currentTarget.style.boxShadow = "0 0 40px oklch(0.82 0.15 200 / 0.6)";
                },
                onMouseLeave: (e) => {
                  e.currentTarget.style.transform = "scale(1)";
                  e.currentTarget.style.boxShadow = "0 0 25px oklch(0.82 0.15 200 / 0.4)";
                },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onClick: () => {
                  var _a2;
                  return (_a2 = document.querySelector("#contact")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                },
                className: "px-8 py-3 rounded-full font-semibold text-sm transition-all duration-300 cursor-pointer",
                style: {
                ...
                onMouseEnter: (e) => {
                  e.currentTarget.style.transform = "scale(1.05)";
                  e.currentTarget.style.boxShadow = "0 0 20px oklch(0.82 0.15 200 / 0.3)";
                },
                onMouseLeave: (e) => {
                  e.currentTarget.style.transform = "scale(1)";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
...
function About() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "fade-up", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-label mb-3", children: "Get to know me" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(135deg, oklch(0.12 0.03 258), oklch(0.15 0.03 258))",
                border: "1px solid oklch(0.25 0.04 258)",
                boxShadow: "0 0 60px oklch(0.82 0.15 200 / 0.15), 0 0 120px oklch(0.60 0.25 310 / 0.1)"
              },
              children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "oklch(0.73 0.04 250)" },
                children: "Hello! I'm Tamilarasan, a passionate and driven software developer who recently completed my undergraduate studies. I enjoy exploring the intersections of programming, machine learning, and real-world problem solving."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "oklch(0.73 0.04 250)" },
                children: "My journey in tech began with curiosity and has grown into a dedicated pursuit of building impactful, intelligent software solutions."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { size: 20, style: { color: "#33D6FF" } })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        className: "text-sm",
                        style: { color: "oklch(0.73 0.04 250)" },
                        children: "Sankara College of Science and Commerce, Coimbatore"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "Under Graduate — Completed"
                      }
                    )
                  ] })
                ] })
...
function Skills() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "fade-up", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-label mb-3", children: "What I work with" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "h2",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: SKILLS.map((skill, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkillCard, { skill, delay: i * 120 }, skill.name)) })
      ] }) })
    }
  );
}
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(135deg, oklch(0.82 0.15 200 / 0.2), oklch(0.60 0.25 310 / 0.2))"
            },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 22, style: { color: "#33D6FF" } })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h3",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", style: { color: "#33D6FF" }, children: "Proficiency" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SkillBar, { level: skill.level, delay })
      ]
    }
  );
}
function Projects() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      style: { background: "oklch(0.09 0.025 258)" },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "fade-up", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-label mb-3", children: "What I've built" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "h2",
          {
            className: "text-4xl md:text-5xl font-bold mb-14",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "linear-gradient(135deg, oklch(0.10 0.04 260) 0%, oklch(0.12 0.06 280) 100%)"
                  },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          background: "linear-gradient(135deg, oklch(0.82 0.15 200 / 0.2), oklch(0.60 0.25 310 / 0.3))",
                          boxShadow: "0 0 40px oklch(0.82 0.15 200 / 0.2)"
                        },
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { size: 36, style: { color: "#33D6FF" } })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-3 p-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-label mb-2", children: "Featured Project" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h3",
                  {
                    className: "text-2xl md:text-3xl font-bold mb-4",
                    style: { color: "oklch(0.95 0.02 250)" },
                    children: "Fake News Detection"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    style: { color: "oklch(0.73 0.04 250)" },
                    children: "A machine learning based system that detects and classifies fake news articles using NLP techniques including text preprocessing, feature extraction, and classification algorithms. Built to combat misinformation in digital media by providing accurate, real-time classification of news content."
                  }
                ),
...
function Languages() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      className: "py-24 px-6",
      style: { background: "oklch(0.07 0.02 260)" },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "fade-up", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-label mb-3", children: "Communication" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "h2",
          {
            className: "text-4xl md:text-5xl font-bold mb-14",
            ...
            children: [
              "Languages ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Known" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-6", children: LANGUAGES.map((lang) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl mb-4", children: lang.flag }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      style: { background: "oklch(0.09 0.025 258)" },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "fade-up", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-label mb-3", children: "Let's connect" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "h2",
          {
            className: "text-4xl md:text-5xl font-bold mb-14",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 24, style: { color: "#33D6FF" } })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      style: { color: "oklch(0.95 0.02 250)" },
                      children: "tamilarasancbscit2025@sankara.ac.in"
                    }
                  )
                ] })
              ]
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 24, style: { color: "#A855F7" } })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: { color: "oklch(0.65 0.04 250)" },
                  children: "I'm actively looking for exciting roles in software development and ML engineering. Feel free to reach out via email or phone — I'd love to connect!"
                }
              )
            ]
          }
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", style: { color: "oklch(0.50 0.04 250)" }, children: [
        "© ",
        year,
        " TAMILARASAN. Built with",
        " ",
...
function ScrollToTop() {
  ...
  return visible ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { size: 20, style: { color: "oklch(0.07 0.02 260)" } })
    }
  ) : null;
}
function App() {
